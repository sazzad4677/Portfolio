...
const OrbitBadge: React.FC<OrbitBadgeProps> = ({ badge, angle, cx, cy, radius }) => {
    ...
    return (
        <div ref={ref} className="pointer-events-none absolute will-change-[transform,left,top,opacity,filter]">
            <div className={`flex items-center gap-2 whitespace-nowrap rounded-full border border-on-background/[0.08] ${badge.color} px-3 py-1.5 shadow-lg shadow-black/10 backdrop-blur-lg`}>
